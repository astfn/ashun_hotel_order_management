...
/* 1 */
{
    "_id" : ObjectId("617cfc20bfc99dfc4f3870df"),
    "applyTime" : 1635580960662.0,
    "orderId" : "617cfbf2bfc99dfc4f3870de",
    "applyReason" : "不好意思，手滑点错了，对不起哈，555~。不好意思，手滑点错了，对不起哈，555~。不好意思，手滑点错了，对不起哈，555~。不好意思，手滑点错了，对不起哈，555~。不好意思，手滑点错了，对不起哈，555~。不好意思，手滑点错了，对不起哈，555~。"
}

/* 2 */
{
    "_id" : ObjectId("617cfcebbfc99dfc4f3870e2"),
    "applyTime" : 1635581163643.0,
    "orderId" : "617cfcc4bfc99dfc4f3870e1",
    "applyReason" : "临时有变，换成双床房了！"
}
```
    ...
    "comments" : [ 
        {
            ...
            "content" : "由于个人原因，很遗憾没有成功体验，但管理人员非常负责，合理的处理了订单。"
        }, 
        {
            "uid" : "15737082601",
            "orderId" : "617cb83d31126a8b9c52c9af",
            "time" : 1635563642509.0,
            "content" : "很好的体验，希望该活动一直保持下去，让大家也都能有奢华体验！！"
        }
    ]
}
...
/* 4 */
{
    "_id" : ObjectId("617caacacb4d369ebec95c3d"),
    "type" : "success",
    "intoTime" : 1635560138619.0,
    "adminInfo" : {
        "nickName" : "Ashun",
        "phone" : "15737082601"
    },
    "content" : "尊敬的用户们，为了避免特殊情况，现在支持成功下单后 5 分钟内无理由退掉订单！"
}
```
...
/* 3 */
{
    "_id" : ObjectId("617cab76cb4d369ebec95c40"),
    "userInfo" : {
        "nickName" : "阿顺特烦恼",
        "phone" : "15737082602"
    },
    "time" : 1635560310206.0,
    "content" : "客服非常专业，处理问题精准高效！但客服人员较少"
}
```
...
/* 1 */
{
    "_id" : ObjectId("617cfbc6bfc99dfc4f3870dc"),
    "type" : "success",
    "buyTime" : 1635580870898.0,
    "adminInfo" : {
        "nickName" : "系统"
    },
    "uid" : "15737082602",
    "goodsId" : "616be67fed2b27e38c229d5c",
    "buySum" : 1
}

/* 2 */
{
    "_id" : ObjectId("617cfbddbfc99dfc4f3870dd"),
    "type" : "success",
    "buyTime" : 1635580893930.0,
    "adminInfo" : {
        "nickName" : "系统"
    },
    "uid" : "15737082602",
    "goodsId" : "616be3d9ed2b27e38c229d13",
    "buySum" : 1
}

/* 3 */
{
    "_id" : ObjectId("617cfbf2bfc99dfc4f3870de"),
    "type" : "pending",
    "buyTime" : 1635580914083.0,
    "adminInfo" : {
        "nickName" : "系统"
    },
    "uid" : "15737082602",
    "goodsId" : "616becdaed2b27e38c229e00",
    "buySum" : 1,
    "applyReason" : "不好意思，手滑点错了，对不起哈，555~。不好意思，手滑点错了，对不起哈，555~。不好意思，手滑点错了，对不起哈，555~。不好意思，手滑点错了，对不起哈，555~。不好意思，手滑点错了，对不起哈，555~。不好意思，手滑点错了，对不起哈，555~。",
    "applyTime" : 1635580960662.0
}
...
/* 4 */
{
    "_id" : ObjectId("617cfcaebfc99dfc4f3870e0"),
    "type" : "success",
    "buyTime" : 1635581102035.0,
    "adminInfo" : {
        "nickName" : "系统"
    },
    "uid" : "15737082601",
...
/* 5 */
{
    "_id" : ObjectId("617cfcc4bfc99dfc4f3870e1"),
    "type" : "cancel",
    "buyTime" : 1635581124538.0,
    "adminInfo" : {
        "nickName" : "向军",
        "phone" : "15737082602"
    },
    ...
    "applyReason" : "临时有变，换成双床房了！",
    "applyTime" : 1635581163643.0,
    "cancelTime" : 1635581190241.0,
    "reason" : "用户临时有变，换成双床房了！"
}
```
