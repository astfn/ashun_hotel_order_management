...
const login_bgImg = require("@/assets/images/login_bgImg.jpg").default;
...
export const LoginWrapper = styled.div`
  ...
  strong {
    ...
    font-size: 25px;
    color: white;
    text-shadow: 4px 4px 5px #ffb3b3, 1px 1px 10px red, -1px -1px 10px red,
      -4px -4px 5px #ffb3b3;
  ...
  .label {
    text-align: left;
    color: white;
    text-shadow: 2px 2px 3px #ffb3b3, 1px 1px 5px red, -1px -1px 5px red,
      -2px -2px 3px #ffb3b3;
  }
  .columns.input,
  input {
